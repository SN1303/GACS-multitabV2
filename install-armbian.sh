...
install_multitab_and_restore() {
    ...
    if [ -d "$SCRIPT_DIR/genieacs" ]; then
        ...
        echo -e "${GREEN}✅ Multitab berhasil diinstal ke $NODE_MODULES_DIR/genieacs${NC}"
        ...
        if [ -d "$SCRIPT_DIR/db" ]; then
            ...
            echo -e "${GREEN}✅ Restore virtual parameter selesai${NC}"
        else
        ...
        echo -e "${RED}❌ Direktori 'genieacs' tidak ditemukan di $SCRIPT_DIR/genieacs${NC}"
